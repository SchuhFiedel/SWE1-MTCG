...
namespace Client
{
    public class Program
    {
        public static void Main ()
        {
            ...
            int useType = 0;
            Console.WriteLine("DEMO MODE (1), OR CLIENT MODE (2)?");
            Console.Write("< ");
            useType = Int32.Parse(Console.ReadLine());
            ...
            if(useType == 1)
            {
                ...
                if(input == 1)
                {
                    DemoModes DM = new DemoModes(t_client, stream, 1, uri);
                    DM.runDemo();
                }
                else if(input == 2)
                {
                    DemoModes DM = new DemoModes(t_client, stream, 2, uri);
                    DM.runDemo();
                }
            ...
            else if(useType == 2)
            {
                ...
                do
                {
                    ...
                    if (input != 12) //input is automatically set to 12 if in battle mode
                    {
                        do
                        {
                            Console.WriteLine("Please enter a number you see on screen!");
                            input = Int32.Parse(Console.ReadLine());
                        ...
                        }while ((input <= 0) || (input > 12 && input != 20));
                    }
                    switch (input)
                    {
                        case 1:
                        ...
                        case 10:
                            //DONE
                            Console.WriteLine("Show Score Board");
        ...
        public static void PrintMenu(bool isLoggedIn)
        {
            ...
            if (isLoggedIn)
            {
                ...
                Console.WriteLine("11) Trading Menu //TODO!");
